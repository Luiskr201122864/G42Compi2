...
class AsignacionEdd{
    ...
    lstExpresion:Array<Object>;

    constructor(padre:String, simbolo:Simbolo, lstExpresion:Array<Object> , tipoDeclaracion:string){
        this.padre = padre;
    ...
    ejecutarInstrucciones(resultadoParcial:Array<Object>, entorno:Entorno):any {
        ...
        this.lstExpresion.forEach(function (item) {
            ...
            let valor = recorridoOperaciones(item, entorno);
